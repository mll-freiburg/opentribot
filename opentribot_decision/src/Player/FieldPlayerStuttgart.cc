...
namespace {
  ...
  public:
    ...
    {
      return new FieldPlayerStuttgart (reader);
    }
  };
  Builder the_builder;
}
...
bool
FieldPlayerStuttgart::set_role(const char* role) throw ()
{
...
FieldPlayerStuttgart::FieldPlayerStuttgart (const ConfigReader& cfg) throw () 
...
FieldPlayerStuttgart::~FieldPlayerStuttgart () throw () 
{}
