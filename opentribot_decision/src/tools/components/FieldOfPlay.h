...
namespace TribotsTools {
  ...
  class FieldOfPlay : public QWidget {
   ...
   public:
    ...
    /** wird true uebergeben, fuehrt jede Mausaktion (egal mit welcher Tastenkombination) zu einem SL-Hint */
    void forceMouseLocalizationClick (bool) throw ();
    void forceMouseGotoClick (bool) throw ();
  ...
  public slots:  // Anzeigen bestimmter Informationen ein/ausschalten oder Bildausschnitt veraendern
    ...
    void show_colored_goals (bool);
    void show_direction (bool);
  ...
  private:
    ...
    std::vector<Tribots::LineSegment> field_lines2;
    std::vector<Tribots::Arc> field_arcs2;
  ...
  protected:
    ...
    /** Zeichnen mit aktuellem Pen und Brush */
    void paintObjects (QPainter&,  const std::vector<Tribots::LineSegment>&);
    void paintObjects (QPainter&,  const std::vector<Tribots::Arc>&);
  };
