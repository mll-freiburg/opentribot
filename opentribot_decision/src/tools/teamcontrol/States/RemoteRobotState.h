...
namespace TribotsTools {
  ...
  struct RemoteRobotState {
    ...
    bool exit_request;                             ///< soll an das Robotcontrol ein ausschaltsignal gesendet werden?
    ...
    bool desired_slhint_and_activate;           ///< true, wenn SL-Hint gesetzt werden soll bis Position stimmt und danach aktiviert werden soll
    ...
    double pingtime;                            ///< Pingzeit in msec, negativ=gestoert
    ...
    RemoteRobotState () :
      ...
      exit_request (false),
      desired_slhint_and_activate (false),
