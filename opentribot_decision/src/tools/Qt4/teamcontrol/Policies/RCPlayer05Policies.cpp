...
namespace {
  ...
  public:
    ...
    TribotsTools::Policy* get_policy (const std::string&, const Tribots::ConfigReader& reader) throw (Tribots::TribotsException,std::bad_alloc) {
      return new RCPlayer05::RCPlayerDDAPolicy;
    }
  };
  ...
  public:
    ...
    TribotsTools::Policy* get_policy (const std::string&, const Tribots::ConfigReader& reader) throw (Tribots::TribotsException,std::bad_alloc) {
      return new RCPlayer05::RCPlayerDSAPolicy;
    }
  };
  ...
  public:
    ...
    TribotsTools::Policy* get_policy (const std::string&, const Tribots::ConfigReader& reader) throw (Tribots::TribotsException,std::bad_alloc) {
      return new RCPlayer05::RCPlayerDDSAPolicy;
    }
  };
...
RCPlayer05::RCPlayerDDAPolicy::RCPlayerDDAPolicy () : StaticPolicy (4) {
  policy_name = "RC05DDA";
...
RCPlayer05::RCPlayerDSAPolicy::RCPlayerDSAPolicy () : StaticPolicy (4) {
  policy_name = "RC05DSA";
  playertype = "RCPlayer05";
...
RCPlayer05::RCPlayerDDSAPolicy::RCPlayerDDSAPolicy () : DynamicDefendOffendPolicy (new RCPlayer05::RCPlayerDDAPolicy, new RCPlayer05::RCPlayerDSAPolicy) {
