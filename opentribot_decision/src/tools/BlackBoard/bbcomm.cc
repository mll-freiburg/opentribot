...
bool
BBComm::use_as_client (char const *addr, int port)
{
  is_server=false;
...
bool
BBComm::update_name (std::string msg)
{
...
bool
BBComm::update_team (std::string msg)
{
