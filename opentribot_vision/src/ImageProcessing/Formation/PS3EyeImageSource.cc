...
//					     _imgbuf->size);
	...
	//memcpy (_imgbuf->buffer, _buffer[_frame], _imgbuf->size);
	_imgbuf->buffer=(unsigned char*)_buffer[_frame];
...
//    cout <<"Camera Parameter set " << t2.elapsed_usec ()<<endl;
  ...
  void PS3ImageSource::setupBuffer ()
  {
    ...
    //reqqbuf.memory = V4L2_MEMORY_USERPTR;
    reqbuf.count = 2;
